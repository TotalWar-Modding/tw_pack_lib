...
pub fn build_pack_from_memory(input: &Vec<PackedFile>, output_file: &mut File, version: &PFHVersion, bitmask: &PFHFlags, file_type: &::PFHFileType, pfh_timestamp: u32) -> Result<(), BuildPackError> {
